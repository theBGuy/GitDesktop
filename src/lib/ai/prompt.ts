 ...
 *  KEEP IN SYNC: `branch_prefix_counts` (src-tauri/src/mcp_server/generate.rs). */
function branchPrefixCounts(
  names: string[],
 ...
 *  KEEP IN SYNC: `branch_prefix_section` (src-tauri/src/mcp_server/generate.rs). */
function branchPrefixSection(names: string[]): string | null {
