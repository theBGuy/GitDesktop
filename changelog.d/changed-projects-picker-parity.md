- **Projects on every pull request, and in the command palette.** The **Projects** picker
  ...
  palette on issues and pull requests alike; the **assignees**, **labels**, and
  **reviewers** pickers walk their rows with the arrow keys, and Tab cycles those rows so
  you can work the whole list one-handed; and the Projects picker says when an item sits
