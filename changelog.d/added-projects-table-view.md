- **Table views open as tables.** A GitHub Project view saved as a table now opens as
  ...
  **Title** first and the rest in the view's saved order, with assignees, labels,
  ...
  its cell: click it or press **Enter**, and **Esc** backs out without saving. The arrow
  keys move cell by cell and **Page Up / Page Down** a screen at a time, rows take the
  same selection, menu and bulk bar as cards on the board, and in a table that neither
  sorts nor groups its rows, with archived cards hidden, **Alt/Option+↑ / ↓** move the
  row you're on through the project order. The **Project fields** line on an issue or
  pull request reads those same fields too.
