- Failures say why at a glance: error toasts lead with Git's reason for a
  ...
  and the review panel still show the full output, and so does the
  notification itself: its arrow button (or the right arrow key on the row)
  unfolds the whole text beneath it, with **Open in Details** when it runs long.
